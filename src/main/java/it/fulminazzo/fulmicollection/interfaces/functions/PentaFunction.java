...
/**
 * Interface that represents a five parameters function.
 * (F, S, T, Q, P) -&#62; R
 *
 ...
 */
@FunctionalInterface
public interface PentaFunction<F, S, T, Q, P, R> {
     ...
     */
    R apply(F first, S second, T third, Q fourth, P fifth);
     ...
     */
    default <V> PentaFunction<F, S, T, Q, P, V> andThen(Function<? super R, ? extends V> after) {
